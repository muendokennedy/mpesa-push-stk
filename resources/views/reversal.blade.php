...
<body>
    <div class="container">
        <div class="card-container">
            <div class="card">
                <div class="card-header">C2B Reversal transaction</div>
                <div class="card-body">
                    <form action="#">
                        @csrf
                        <div class="input-box">
                        ...
                        <button id="simulate-transaction" class="btn">Reverse Transaction</button>
    ...
    <script>
        ...
        document.getElementById('simulate-transaction').addEventListener('click', (e) => {
            ...
            xhrHttp.open('post', '/reverse-transaction', true);
